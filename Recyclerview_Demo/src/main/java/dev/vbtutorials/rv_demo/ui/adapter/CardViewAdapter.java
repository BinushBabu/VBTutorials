...
public class CardViewAdapter extends RecyclerView.Adapter<HolderUser>{
    List<User> list;
    Context mContext;

    public CardViewAdapter(List<User> list, Context mContext) {
    ...
    public HolderUser onCreateViewHolder(ViewGroup parent, int viewType)
    {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(
                R.layout.card_holder_user, parent, false);
